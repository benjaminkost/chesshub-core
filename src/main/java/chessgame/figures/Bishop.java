...
public class Bishop extends ChessFigure {
	 ...
	 */
	private final static String BLACK_BISHOP_PATH = "chessgame/figures/images/BlackBishop.png";

	/**
	 * The image path for the white figure
	 */
	private final static String WHITE_BISHOP_PATH = "chessgame/figures/images/WhiteBishop.png";
	...
	public String getPath() {
		if (side == ChessColor.BLACK)
			return BLACK_BISHOP_PATH;
		else
			return WHITE_BISHOP_PATH;
	}
