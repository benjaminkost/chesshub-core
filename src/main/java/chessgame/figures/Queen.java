...
public class Queen extends ChessFigure {
	 ...
	 */
	private final static String BLACK_QUEEN_PATH = "chessgame/figures/images/BlackQueen.png";

	/**
	 * The image path for the white figure
	 */
	private final static String WHITE_QUEEN_PATH = "chessgame/figures/images/WhiteQueen.png";
	...
	public String getPath() {
		if (side == ChessColor.BLACK)
			return BLACK_QUEEN_PATH;
		else
			return WHITE_QUEEN_PATH;
	}
