...
public class Rook extends ChessFigure {
	 ...
	 */
	private final static String BLACK_ROOK_PATH = "chessgame/figures/images/BlackRook.png";

	/**
	 * The image path for the white figure
	 */
	private final static String WHITE_ROOK_PATH = "chessgame/figures/images/WhiteRook.png";
	...
	public String getPath() {
		if (side == ChessColor.BLACK)
			return BLACK_ROOK_PATH;
		else
			return WHITE_ROOK_PATH;
	}
