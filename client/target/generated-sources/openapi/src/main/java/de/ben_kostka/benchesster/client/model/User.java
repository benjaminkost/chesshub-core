...
public class User {
  public static final String JSON_PROPERTY_USER_I_D = "user_ID";
  ...
  public User userID(@javax.annotation.Nullable Integer userID) {
    this.userID = userID;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(userID, username, firstName, lastName, email, password, phone, userStatus);
  }
