...
public class UploadGameApiController {
    private UploadGameService uploadGameService;
    public UploadGameApiController(UploadGameService uploadGameService){
    ...
    public ResponseEntity<GameDto> uploadGameFromFile(@RequestParam("gameFile") MultipartFile gameFile) throws Exception {
